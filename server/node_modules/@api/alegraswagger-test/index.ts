...
class SDK {
  ...
  constructor() {
    ...
    this.core = new APICore(this.spec, 'alegraswagger-test/1.0.0 (api/6.1.3)');
  }
...
export type { ContactsAttachmentBodyParam, ContactsAttachmentMetadataParam, ContactsAttachmentResponse200, ContactsAttachmentResponse400, ContactsDetailsMetadataParam, ContactsDetailsResponse201, ContactsDetailsResponse404, DeleteAttachmentContactMetadataParam, DeleteAttachmentContactResponse200, DeleteAttachmentContactResponse404, DeleteContactMetadataParam, DeleteContactResponse200, DeleteContactResponse400, DeleteContactResponse404, DeleteMultipleContactsMetadataParam, DeleteMultipleContactsResponse200, DeleteMultipleContactsResponse400, EditContactBodyParam, EditContactMetadataParam, EditContactResponse201, EditContactResponse400, EditContactResponse404, ListContactsMetadataParam, ListContactsResponse200, ListContactsResponse400, PostContactsBodyParam, PostContactsResponse200, PostContactsResponse400, RestoreContactMetadataParam, RestoreContactResponse200, RestoreContactResponse404 } from './types';
